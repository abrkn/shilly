...
test('internalBchAddressToStandard returns base58 before Jan 14, 2018', t => {
  ...
  t.is(
    internalBchAddressToStandard('1BpEi6DfDAUFd7GtittLSdBeYJvcoaVggu'),
...
test('bchAddressToInternal does not convert base58', t => {
  t.is(
    bchAddressToInternal('1BpEi6DfDAUFd7GtittLSdBeYJvcoaVggu'),
    '1BpEi6DfDAUFd7GtittLSdBeYJvcoaVggu'
  );
  t.is(
    bchAddressToInternal('3CWFddi6m4ndiGyKqzYvsFYagqDLPVMTzC'),
